...
\includegraphics[width=1.5in]{"01-default-shaders"}
\includegraphics[width=1.5in]{"01-default-material"}
...
\includegraphics[width=3.3in]{"03-create-shader"}

\includegraphics[width=3.3in]{"04-material-edit"}

\includegraphics[width=3.3in]{"05-uniform-editor"}
...
\includegraphics[width=3.3in]{"07-create-object"}

\includegraphics[width=3.3in]{"08-inspector-material"}
